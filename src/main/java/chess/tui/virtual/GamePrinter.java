...
/**
 * Renders a GameState to a VirtualTerminal. Produces the same board view as the TUI but without
 * cursor/selection UI.
 */
public class GamePrinter {
  ...
  /**
   * Play out a list of moves (alternating) and capture a frame after each move. Returns all frames
   * joined.
   */
