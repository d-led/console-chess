...
/**
 * Port of adam-mcdaniel/chess-engine (MIT license). Uses piece-square positional tables + material
 * evaluation with minimax search. Source: https://github.com/adam-mcdaniel/chess-engine
 *
 * <p>ELO ~1500-1700 depending on search depth.
 */
public class AdamEngine implements ChessEngine {
  ...
  @Override
  public String name() {
    return "Adam (minimax depth " + SEARCH_DEPTH + ")";
  }
