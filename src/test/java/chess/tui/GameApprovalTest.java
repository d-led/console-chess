...
/**
 * Approval tests: play through a game with fixed-seed AI, capture every board state, and verify the
 * output is stable.
 */
class GameApprovalTest {
  ...
  void playFullGameWithFixedSeedAI() {
    ...
    List<String> allPlayerMoves =
        List.of("e2e4", "g1f3", "d2d4", "b1c3", "c1g5", "f1d3", "e1g1", "d1e2", "a2a3", "h2h3");
